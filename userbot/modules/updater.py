...
async def upstream(event):
    ...
    if force_update:
        ...
        await event.edit('`Proses Update Willyams Bot, ....🛠️`')
        await event.edit('`Proses Update Willyams Bot, loading....🛠️`')
        await event.edit('`Proses Update Willyams Bot, updating....🛠️`')
        await event.edit('`Proses Update Willyams Bot, silahkan tunggu....🛠️`')
    if conf == "now":
